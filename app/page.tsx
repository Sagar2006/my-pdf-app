...
export default function Home() {
  ...
  const handleChooseFileClick = () => {
    if (pdfUploaderRef.current) {
      pdfUploaderRef.current.triggerFileInput();
    }
  };
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Upload and download PDF files" />
      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-24">
        ...
        {/* Add PdfUploader component here */}
        <div className="mt-8">
